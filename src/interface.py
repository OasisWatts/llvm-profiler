...
# ratio radio button
		self.ratio_btn = QRadioButton("Show Ratio Instead", self)
		self.ratio_btn.clicked.connect(self.ratio_clk)
		self.ratio_btn.resize(210, 40)
		self.ratio_btn.move(1390, 20)
		self.ratio_btn.setStyleSheet("QRadioButton{font-size: 17px;} QRadioButton::indicator{ width: 30px; height: 30px; };")
# labels
		ctg_label = QLabel(self)
		ctg_label.setText("Category")
		ctg_label.resize(100, 40)
		ctg_label.move(100, 20)
